...
def plot_training(history):
	...
	plt.legend()
	plt.savefig('lstm_softmax_40000vocab_training_validation_accuracy.png')
	plt.figure()
	...
	plt.legend()
	plt.savefig('lstm_softmax_40000vocab_training_validation_loss.png')
...
model.save('40000vocab_lstm_softmax_lstm.h5')
