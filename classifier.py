...
def plot_training(history):
	...
	plt.legend()
	plt.savefig('lstm_sigmoid_40000vocab_lemmatized_training_validation_accuracy.png')
	plt.figure()
	plt.plot(epochs, loss, 'r', label='Training Loss')
	plt.plot(epochs, val_loss, 'b', label='Validation Loss')
	plt.title('Training and validation loss')
	plt.legend()
	plt.savefig('lstm_sigmoid_40000vocab_lemmatized_training_validation_loss.png')
...
model.save('40000Vocab_lemmatized_sigmoid_lstm.h5')
